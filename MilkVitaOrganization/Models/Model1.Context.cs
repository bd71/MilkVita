...
namespace MilkVitaOrganization.Models
{
    ...
    public partial class MilkVitaEntities : DbContext
    {
        public MilkVitaEntities()
            : base("name=MilkVitaEntities")
        {
        }
        ...
        public virtual DbSet<tbl_Receive> tbl_Receive { get; set; }
        public virtual DbSet<tbl_Registration> tbl_Registration { get; set; }
        public virtual DbSet<tbl_ShopList> tbl_ShopList { get; set; }
        public virtual DbSet<tbl_Supplier> tbl_Supplier { get; set; }
        public virtual DbSet<tbl_Unit> tbl_Unit { get; set; }
        public virtual DbSet<tbl_VanDriverList> tbl_VanDriverList { get; set; }
        public virtual DbSet<tbl_ZoneList> tbl_ZoneList { get; set; }
        public virtual DbSet<tbl_ZoneOfficerList> tbl_ZoneOfficerList { get; set; }
        public virtual DbSet<tbl_ZoneSuperVisor> tbl_ZoneSuperVisor { get; set; }
